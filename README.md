...
Integrate Firebase RemoteConfig with any `Key name` and configure it in [this json format](https://github.com/trinhxuanminh/AdMobManager/blob/develop/5.4.0/Sources/AdMobManager/Ad/Template/RegistrationStructure.json).
**Note**: The name of each ad is unique.

## Demo
Refer to the following [Demo project](https://github.com/trinhxuanminh/DemoAdMobManager/tree/develop/5.4.0) to implement the ad.
...
### 3. NativeAd
- Download & add file [`CustomNativeAdView.xib`](https://github.com/trinhxuanminh/AdMobManager/blob/develop/5.4.0/Sources/AdMobManager/Ad/Template/CustomNativeAdView.xib).
